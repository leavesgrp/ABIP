...
struct SuiteSparse_config_struct
{
    ...
    abip_float (*hypot_func) (abip_float, abip_float) ;     /* pointer to hypot */
...
abip_float SuiteSparse_toc  /* return time in seconds since last tic */
(
      abip_float tic [2]      /* input: from last call to SuiteSparse_tic */
) ;
