...
)
{
    	...
    	{
		sym = (2 * (abip_float) nzboth) / ((abip_float) (nz - nzdiag)) ;
    	}
		...
		ABIPInfo [AMD_N] = n ;
		ABIPInfo [AMD_NZ] = nz ;
		ABIPInfo [AMD_SYMMETRY] = sym ;	    	/* symmetry of pattern of A */
		ABIPInfo [AMD_NZDIAG] = nzdiag ;	    	/* nonzeros on diagonal of A */
		ABIPInfo [AMD_NZ_A_PLUS_AT] = nzaat ;   	/* nonzeros in A+A' */
    	}
