...
(
    	...
    	abip_float Control [ ],	/* input array of size AMD_CONTROL */
    	abip_float ABIPInfo [ ]	/* output array of size AMD_INFO */
)
{
    	Int i; 
    	Int j; 
	...
	Int *Tp;
    	...
    	AMD_2 (n, Pe, Iw, Len, iwlen, pfree, Nv, Pinv, P, Head, Elen, Degree, W, Control, ABIPInfo) ;
}
