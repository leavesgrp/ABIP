...
(
            ...
            abip_float Control [ ],     /* input Control settings, of size AMD_CONTROL */
            abip_float ABIPInfo [ ]     /* output ABIPInfo statistics, of size AMD_INFO */
) ;
 ...
 *           parameters.  Defaults are used if Control is ABIP_NULL.
 *
 ...
 *       ABIPInfo: a double array of size AMD_INFO, containing statistical
 *           information.  Ignored if ABIPInfo is ABIP_NULL.
 *
 ...
 *           future versions.
 *
 * The ABIPInfo array provides statistics about the ordering on output.  If it is
 * not present, the statistics are not returned.  This is not an error
 * condition.
 * 
 *       ABIPInfo [AMD_STATUS]:  the return value of AMD, either AMD_OK,
 *           AMD_OK_BUT_JUMBLED, AMD_OUT_OF_MEMORY, or AMD_INVALID.
 *
 *       ABIPInfo [AMD_N]: n, the size of the input matrix
 *
 *       ABIPInfo [AMD_NZ]: the number of nonzeros in A, nz = Ap [n]
 *
 *       ABIPInfo [AMD_SYMMETRY]:  the symmetry of the matrix A.  It is the number
 ...
 *
 *       ABIPInfo [AMD_NZDIAG]: the number of entries on the diagonal of A.
 *
 *       ABIPInfo [AMD_NZ_A_PLUS_AT]:  the number of nonzeros in A+A', excluding the
 ...
 *
 *       ABIPInfo [AMD_NDENSE]: the number of "dense" rows/columns of A+A' that were
 *           removed from A prior to ordering.  These are placed last in the
 *           output order P.
 *
 *       ABIPInfo [AMD_MEMORY]: the amount of memory used by AMD, in bytes.  In the
 ...
 *
 *       ABIPInfo [AMD_NCMPA]: the number of garbage collections performed.
 *
 *       ABIPInfo [AMD_LNZ]: the number of nonzeros in L (excluding the diagonal).
 ...
 *
 *       ABIPInfo [AMD_NDIV]: the number of divide operations for a subsequent LDL'
 *           or LU factorization of the permuted matrix A (P,P).
 *
 *       ABIPInfo [AMD_NMULTSUBS_LDL]:  the number of multiply-subtract pairs for a
 *           subsequent LDL' factorization of A (P,P).
 *
 *       ABIPInfo [AMD_NMULTSUBS_LU]:  the number of multiply-subtract pairs for a
 *           subsequent LU factorization of A (P,P), assuming that no numerical
 *           pivoting is required.
 *
 *       ABIPInfo [AMD_DMAX]:  the maximum number of nonzeros in any column of L,
 *           including the diagonal.
 *
 *       ABIPInfo [14..19] are not used in the current version, but may be used in
 *           future versions.
 */    
